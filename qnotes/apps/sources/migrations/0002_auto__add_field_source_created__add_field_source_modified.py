...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sources_source', 'created',
        ...
        db.add_column('sources_source', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('sources_source', 'created')

        # Deleting field 'Source.modified'
        db.delete_column('sources_source', 'modified')
