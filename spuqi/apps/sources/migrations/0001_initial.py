...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sources_source_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('source', models.ForeignKey(orm[u'sources.source'], null=False)),
            ('author', models.ForeignKey(orm[u'authors.author'], null=False))
        ))
        db.create_unique(u'sources_source_authors', ['source_id', 'author_id'])
