...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quote.publication_date'
        db.delete_column('quotes_quote', 'publication_date')


    def backwards(self, orm):
        # Adding field 'Quote.publication_date'
        db.add_column('quotes_quote', 'publication_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 2, 0, 0)),
                      keep_default=False)
