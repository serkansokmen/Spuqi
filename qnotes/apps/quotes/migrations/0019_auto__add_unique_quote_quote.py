...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Quote', fields ['quote']
        db.create_unique('quotes_quote', ['quote'])


    def backwards(self, orm):
        # Removing unique constraint on 'Quote', fields ['quote']
        db.delete_unique('quotes_quote', ['quote'])
    ...
    models = {
        ...
        'quotes.quote': {
            ...
            'quote': ('django.db.models.fields.TextField', [], {'unique': 'True', 'max_length': '1200'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
