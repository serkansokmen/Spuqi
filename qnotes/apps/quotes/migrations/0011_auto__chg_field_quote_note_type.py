...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quote.note_type'
        db.alter_column('quotes_quote', 'note_type', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Quote.note_type'
        db.alter_column('quotes_quote', 'note_type', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'quotes.quote': {
            ...
            'note_type': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
