...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('quotes_quote', 'created')

        # Deleting field 'Quote.modified'
        db.delete_column('quotes_quote', 'modified')
