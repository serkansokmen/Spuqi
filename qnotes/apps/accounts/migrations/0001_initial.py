...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='account_profile', unique=True, to=orm['auth.User'])),
        ))
    ...
    models = {
        'accounts.userprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'account_profile'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'auth.group': {
