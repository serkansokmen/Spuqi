...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.slug'
        db.add_column('quotes_quote', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=u'lorem', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.slug'
        db.delete_column('quotes_quote', 'slug')
