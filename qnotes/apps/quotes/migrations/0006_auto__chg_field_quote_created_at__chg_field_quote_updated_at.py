...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quote.created_at'
        db.alter_column('quotes_quote', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Quote.updated_at'
        db.alter_column('quotes_quote', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Quote.created_at'
        db.alter_column('quotes_quote', 'created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Quote.updated_at'
        db.alter_column('quotes_quote', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
