...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.quote'
        db.add_column('quotes_note', 'quote',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['quotes.Quote']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Note.quote'
        db.delete_column('quotes_note', 'quote_id')
