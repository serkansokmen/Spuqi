...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'collections_collection', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_collections', to=orm['accounts.SiteUser'])),
        ...
        db.create_table(u'collections_collection_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm[u'collections.collection'], null=False)),
            ('source', models.ForeignKey(orm[u'sources.source'], null=False))
        ))
        db.create_unique(u'collections_collection_sources', ['collection_id', 'source_id'])

        # Adding M2M table for field members on 'Collection'
        db.create_table(u'collections_collection_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm[u'collections.collection'], null=False)),
            ('siteuser', models.ForeignKey(orm[u'accounts.siteuser'], null=False))
        ))
        db.create_unique(u'collections_collection_members', ['collection_id', 'siteuser_id'])
    ...
    models = {
        ...
        u'collections.collection': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'followed_collections'", 'symmetrical': 'False', 'to': u"orm['accounts.SiteUser']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'sources': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['sources.Source']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_collections'", 'to': u"orm['accounts.SiteUser']"})
        },
