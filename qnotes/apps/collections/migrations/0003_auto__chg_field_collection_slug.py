...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('collections_collection', 'slug', self.gf('django.db.models.fields.SlugField')(default=u'', max_length=50))

    def backwards(self, orm):

        # Changing field 'Collection.slug'
        db.alter_column('collections_collection', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True))
