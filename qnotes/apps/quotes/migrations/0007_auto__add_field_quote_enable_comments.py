...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.enable_comments'
        db.add_column('quotes_quote', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.enable_comments'
        db.delete_column('quotes_quote', 'enable_comments')
