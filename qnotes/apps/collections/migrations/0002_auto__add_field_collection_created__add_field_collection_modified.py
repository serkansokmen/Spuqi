...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('collections_collection', 'created',
        ...
        db.add_column('collections_collection', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('collections_collection', 'created')

        # Deleting field 'Collection.modified'
        db.delete_column('collections_collection', 'modified')
