...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('quotes_quote', 'quote', self.gf('django.db.models.fields.TextField')(default=u'', max_length=1200))

        # Changing field 'Quote.note'
        db.alter_column('quotes_quote', 'note', self.gf('django.db.models.fields.TextField')(default='', max_length=500))

    def backwards(self, orm):

        # Changing field 'Quote.quote'
        db.alter_column('quotes_quote', 'quote', self.gf('django.db.models.fields.TextField')(max_length=1200, null=True))

        # Changing field 'Quote.note'
        db.alter_column('quotes_quote', 'note', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))
