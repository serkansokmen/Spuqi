...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('authors_author', 'created',
        ...
        db.add_column('authors_author', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('authors_author', 'created')

        # Deleting field 'Author.modified'
        db.delete_column('authors_author', 'modified')
